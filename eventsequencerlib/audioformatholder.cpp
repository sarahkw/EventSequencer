...
int AudioFormatHolder::sampleTypeIndex() const /*enum helper*/
{
    ...
    case AudioFormat::SampleType::SignedInt:   return 0;
    case AudioFormat::SampleType::UnSignedInt: return 1;
    case AudioFormat::SampleType::Float:       return 2;
    }
    return 0; // Compiler
}
...
void AudioFormatHolder::setSampleTypeIndex(int sampleTypeIndex) /*enum helper*/
{
    ...
    case 0: audioFormat_.setSampleType(AudioFormat::SampleType::SignedInt  ); break;
    case 1: audioFormat_.setSampleType(AudioFormat::SampleType::UnSignedInt); break;
    case 2: audioFormat_.setSampleType(AudioFormat::SampleType::Float      ); break;
    }
...
int AudioFormatHolder::endianIndex() const /*enum helper*/
{
    ...
    case AudioFormat::Endian::BigEndian:    return 0;
    case AudioFormat::Endian::LittleEndian: return 1;
    }
    return 0; // Compiler
}
...
{
    switch (endianIndex) {
    case 0: audioFormat_.setEndian(AudioFormat::Endian::BigEndian   ); break;
    case 1: audioFormat_.setEndian(AudioFormat::Endian::LittleEndian); break;
    }
    emit audioFormatChanged();
}
...
void AudioFormatHolder::fromPb(const pb::AudioFormat &pb)
{
    ...
    case pb::AudioFormat_SampleType_UnsetSampleType : audioFormat_.setSampleType(AudioFormat::SampleType::SignedInt   ); break; // Used to have Unset
    ...
    switch (pb.endian()) {
    case pb::AudioFormat_Endian_UnsetEndian   : audioFormat_.setEndian(AudioFormat::Endian::BigEndian   ); break; // Used to have Unset
...
void AudioFormatHolder::fromQAudioFormat(const QAudioFormat &qaf)
{
    ...
    case QAudioFormat::Unknown     : audioFormat_.setSampleType(AudioFormat::SampleType::SignedInt);
        // I don't know, man. I don't think this should happen, though.
        qWarning("Don't know how to convert QAudioFormat::Unknown to one of our enums. Picking SignedInt.");
        break;
