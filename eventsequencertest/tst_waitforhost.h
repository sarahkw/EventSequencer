...
TEST_F(WaitForHostTest, Rekey_Neg_AddOne)
{
    wfh_.rekeyBefore(-1, 1);
    EXPECT_THAT(result(),
                testing::ElementsAre(
                    &qobjs_[1],
                    nullptr,
...
TEST_F(WaitForHostTest, Rekey_Neg_DelOne)
{
    wfh_.rekeyBefore(-1, -1);
    EXPECT_THAT(result(),
            testing::ElementsAre(
...
TEST_F(WaitForHostTest, Rekey_Neg_AddMany)
{
    wfh_.rekeyBefore(-1, 99);
    EXPECT_THAT(result(),
                testing::ElementsAre(
                    nullptr,
                    nullptr,
...
TEST_F(WaitForHostTest, Rekey_Neg_DelMany)
{
    wfh_.rekeyBefore(-1, -99);
    EXPECT_THAT(result(),
                testing::ElementsAre(
